...
class LegalService:
    ...
    _WORD_STEMS: dict[str, str] = {
        ...
        "murdered": "murder", "murdering": "murder", "murders": "murder",
        "robbed": "robbery", "robbing": "robbery",
        "cheated": "cheat", "cheating": "cheat",
        "threatened": "threat", "threatening": "threat", "threats": "threat",
        "kidnapped": "kidnap", "kidnapping": "kidnap",
        "assaulted": "assault", "assaulting": "assault",
        "raped": "rape", "raping": "rape",
        "forged": "forgery", "forging": "forgery",
        "defamed": "defamation", "defaming": "defamation",
        "harassed": "harassment", "harassing": "harassment",
        "phone": "theft", "mobile": "theft", "wallet": "theft",
        "money": "cheat", "fraud": "cheat",
    }
    ...
    def keyword_search(self, text: str, top_k: int = 5) -> list[SectionResult]:
        ...
        # Expand words with stems
        words = set()
        for w in raw_words:
            words.add(w)
            if w in self._WORD_STEMS:
                words.add(self._WORD_STEMS[w])
...
def get_legal_service() -> LegalService:
    """Get or create the LegalService singleton."""
